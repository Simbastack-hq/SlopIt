...
- Platform PR: `createApiRouter({ ..., mcpEndpoint: ${BASE_URL}/mcp })` + mount `createMcpServer` via `StreamableHTTPServerTransport` at `/mcp`. Tracked in `slopit-platform/LAUNCH.md`.
